...
class Grid{
    ...
    grids[0] holds an empty grid. Empty squares are represented byt the caret symbol, "^"
    grids[1] through grids[4] hold preset playing fields where ships are represented by "A" */
